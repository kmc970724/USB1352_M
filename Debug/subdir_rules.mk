...
build-1039534945:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1039534945-inproc

build-1039534945-inproc: ../empty.syscfg
	@echo 'Building file: "$<"'
