...
// Optimize PA-table for board/band: LAUNCHXL-CC1352P1
// TX Power (dBm): 20
...
rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t RF_cmdPropRadioDivSetup =
{
    ...
    .centerFreq = 0x039B, // modified (default: 0x0393)
    .intFreq = 0x8000,
    .loDivider = 0x05,
...
rfc_CMD_FS_t RF_cmdFs =
{
    ...
    .condition.rule = 0x1,
    .condition.nSkip = 0x0,
    .frequency = 0x039B, // modified (default: 0x0393)
    .fractFreq = 0x0000,
